<x-app-layout>
    <title>SmartSIM - {{ $title ?? 'Phone Verification' }}</title>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-extrabold font-display text-slate-900 flex items-center gap-2.5">
                    <div class="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary animate-pulse">
                        <i data-lucide="shield-check" class="w-5 h-5"></i>
                    </div>
                    NIN Phone Verification
                </h1>
                <p class="text-sm text-slate-500 mt-1">Retrieve identity details linked to a phone number instantly.</p>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="p-6 space-y-6">
                            <p class="text-xs text-slate-400 text-center leading-normal max-w-sm mx-auto">
                                Enter the 11-digit phone number below to retrieve NIN records.
                            </p>
