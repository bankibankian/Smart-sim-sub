            ...
            @forelse($plans as $plan)
                <tr class="hover:bg-slate-50/50 transition-colors duration-150">
                    ...
                    <td class="py-3.5 px-2">
                        <span class="inline-block text-xs font-bold px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 uppercase">{{ $plan->plan_type }}</span>
                    </td>
                    ...
                    <td class="py-3.5 px-2 text-right">
                        <button type="button" 
                                ...
                                class="inline-flex items-center gap-1 py-1.5 px-3 bg-indigo-50 hover:bg-[#0056D2] hover:text-white text-[#0056D2] font-bold rounded-lg text-xs transition-all duration-150">
                            Select
                        </button>
                    </td>
                </tr>
